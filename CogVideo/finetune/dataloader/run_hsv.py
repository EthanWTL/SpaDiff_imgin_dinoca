...
print("Flow HSV max after norm+clip:", batch["flow_hsv_channels"].abs().max().item())  # <= 1.0
print("HSV shape:", batch["flow_hsv_channels"].shape)  # Should be [B, T, 3, H, W]
