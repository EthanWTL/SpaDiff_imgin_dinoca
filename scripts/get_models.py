...
pipe = CogVideoXPipeline.from_pretrained(
    "/project/sds-rise/ethan/SpaDiff_Sep8_i2v/huggingface/models/CogVideoX-2b"
)
...
pipe.save_pretrained("/project/sds-rise/ethan/SpaDiff_Sep8_i2v/huggingface/models/CogVideoX-2b-32in-16out")